...
<html data-wf-page="63cc9a315c56b22fc1625683" data-wf-site="63c2574b2405e7464ec569cc">
<head>
  <meta charset="utf-8">
  <title>Quick Response</title>
  <meta content="Quick Response" property="og:title">
  <meta content="Quick Response" property="twitter:title">
...
<body>
      ...
      <nav role="navigation" class="w-nav-menu">
        ...
        <div data-hover="false" data-delay="0" class="w-dropdown">
          ...
          <nav class="w-dropdown-list">
            <a href="#" class="dropdown-link w-dropdown-link">Plain Black- 3</a>
            <a href="#" class="dropdown-link-2 w-dropdown-link">Colored- 5</a>
            <a href="#" class="dropdown-link-4 w-dropdown-link">Full page image- 8</a>
          </nav>
        </div>
  ...
  <div class="w-container">
    <div class="div-block-8">
      <h1 class="heading-6">PAYMENT SUCCESSFULLY RECEIVED!</h1>
    </div>
    <div class="div-block-9"></div>
    <div class="text-block-22">Save this QR code or check your email for a copy of your code and scan it at the scanning kiosk of Printu.<br>Thank you!</div>
    <a href="index.html" class="link">Create New Transaction</a>
  </div>
